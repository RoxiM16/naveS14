...
var juego = new Phaser.Game(450, window.innerHeight, Phaser.CANVAS, 'bloque_juego');
...
var estadoPrincipal = {
    ...
    create: function () {
        // Mostrar pantalla
        fondoJuego = juego.add.tileSprite(0, 0, 450, window.innerHeight, 'fondo');
        ...
        for (var y = 0; y < 6; y++) {
            for (var x = 0; x < 4; x++) {
                var enemigo = enemigos.create(x * 80, y * 40, 'enemigo'); 
